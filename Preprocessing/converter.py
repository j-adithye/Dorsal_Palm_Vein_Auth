...
CLAHE_CLIP           = pp.CLAHE_CLIP       # single CLAHE pass (pre-Sato only)
...
def preprocess_single(src_path: Path, dst_path: Path) -> tuple[bool, str]:
    """
    Run the full 10-step pipeline on one image and save the result.
